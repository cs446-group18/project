...
data class FlightInfo(
    ...
    val flightDuration: Int?,       // flight duration in minutes (e.g. 120 for 2 hours)
    val flightStatus: String?,      // status: {scheduled, landed, cancelled, en-route, delayed}
    val flightNumber: String,       // flight number (e.g. 8838)
    val airlineName: String?,       // airline name (e.g. "Air Canada")

    // Departure airport information
    val depAirportIata: String,                 // IATA code of departure airport (e.g. YYZ for Toronto Pearson)
    val depAirportName: String?,                // name of departure airport (e.g. "Toronto Pearson International Airport")
    val depTerminal: String?,                   // terminal in departure airport (e.g. "1" for Terminal 1 in YYZ)
    val depGate: String?,                       // gate in departure airport (e.g. "F64" in YYZ)
    val depScheduled: LocalDateTime?,           // original scheduled departure time (e.g. 18:35)
    ...
    val depCity: String?,                       // city of departure (e.g. "Toronto")
    val depCountry: String?,                    // country of departure (e.g. "Canada")

    // Arrival airport information
    val arrAirportIata: String,                 // IATA code of arrival airport (e.g. RDU for Raleigh-Durham)
    val arrAirportName: String?,                // name of arrival airport (e.g. "Raleigh-Durham International Airport")
    val arrTerminal: String?,                   // terminal in arrival airport (e.g. "2" for Terminal 2 in RDU)
    val arrGate: String?,                       // gate in arrival airport (e.g. "C12" in RDU)
    ...
    val arrCity: String?,                       // city of arrival (e.g. "Raleigh-Durham")
    val arrCountry: String?,                    // country of arrival (e.g. "USA")

    // Historical delay information
    val delayRate7: Int?,           // percentage of flights delayed in past 7 days (e.g. 14 for 14%)
    val delayRate14: Int?,          // percentage of flights delayed in past 14 days (e.g. 12 for 12%)
    val delayRate30: Int?,          // percentage of flights delayed in past 30 days (e.g. 10 for 10%)
    val avgDelay7: Int?,            // the average length of all delays in past 7 days in minutes (e.g. 30)
    val avgDelay14: Int?,           // the average length of all delays in past 14 days in minutes (e.g. 24)
    val avgDelay30: Int?,           // the average length of all delays in past 30 days in minutes (e.g. 19)
