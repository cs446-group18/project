...
fun Route.privacyPolicy() {
    get("/privacy") {
        call.respondText("""
            ...
            <p>David McNamee, Jenita Zhang, Ivan Chen, Faduma Ahmed, Zi Wen Lim, and Hanz Vora (the DelayWise team) built the DelayWise app as a free app. This SERVICE is provided by the DelayWise team at no cost and is intended
                for use as is.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                which is accessible at DelayWise, unless otherwise defined in this Privacy Policy.</p>
